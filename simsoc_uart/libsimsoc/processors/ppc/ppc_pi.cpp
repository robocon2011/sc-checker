...
namespace simsoc {
  ...
  PseudoStatus ppcPseudoNextPage(PPC_Processor &proc,
                                 const PPC_PseudoInstruction& p) {
    proc.debug() <<"ppcPseudonext_page" <<endl;
    return NEXT_PAGE;
  }

  void ppcTranslateNextPage(PPC_PseudoInstruction& pi) {
    pi.f = ppcPseudoNextPage;
  }

  extern "C"
  PseudoStatus ppc_generic(PPC_Processor &proc,
                           const PPC_PseudoInstruction& pi) {
  ...
  PseudoStatus ppc_add(PPC_Processor &proc, const PPC_PseudoInstruction& p) {
    ...
    const uint32_t a = proc.cpu.gpr[p.args.X.ra];
    const uint32_t b = proc.cpu.gpr[p.args.X.rb];
    proc.cpu.gpr[p.args.X.rt] = a+b;
    return OK;
  }
  ...
  PseudoStatus ppc_add_(PPC_Processor &proc, const PPC_PseudoInstruction& p) {
    ...
    const uint32_t b = proc.cpu.gpr[p.args.X.rb];
    proc.cpu.gpr[p.args.X.rt] = a+b;
    ppc_update_cr0(proc, p.args.X.rt);
    return OK;
  }
...
/*----------------------------------------------------------------------------*/
  ...
  PseudoStatus ppc_addic(PPC_Processor &proc, const PPC_PseudoInstruction& p) {
    ...
    const uint32_t ra_content = proc.cpu.gpr[p.args.D.ra];
    proc.cpu.gpr[p.args.D.rt] = ra_content + p.args.D.d;
    // update XER
    if (proc.cpu.gpr[p.args.D.rt] < ra_content)
      proc.cpu.xer |= XER_CA;
    else
      proc.cpu.xer &= ~XER_CA;
    return OK;
  ...
  PseudoStatus ppc_addic_(PPC_Processor &proc, const PPC_PseudoInstruction& p) {
    ...
    if (proc.cpu.gpr[p.args.D.rt] < ra_content)
      ...
      proc.cpu.xer &= ~XER_CA;
    // update cr0 flags
    ppc_update_cr0(proc, p.args.D.rt);
    return OK;
  }
  ...
  PseudoStatus ppc_and(PPC_Processor &proc, const PPC_PseudoInstruction& p) {
    ...
    proc.cpu.gpr[p.args.X.ra] = proc.cpu.gpr[p.args.X.rt] &  proc.cpu.gpr[p.args.X.rb];
    return OK;
  }
  ...
  PseudoStatus ppc_and_(PPC_Processor &proc, const PPC_PseudoInstruction& p) {
    ...
    // update cr0 flags
    ppc_update_cr0(proc, p.args.X.ra);
    return OK;
  }
  ...
  PseudoStatus ppc_andi_(PPC_Processor &proc, const PPC_PseudoInstruction& p) {
    ...
    proc.cpu.gpr[p.args.D.ra] = proc.cpu.gpr[p.args.D.rt] & p.args.D.d;

    // update cr0 flags
    ppc_update_cr0(proc, p.args.D.ra);
    return OK;
  }
  ...
  PseudoStatus ppc_andis_(PPC_Processor &proc, const PPC_PseudoInstruction& p) {
    ...
    proc.cpu.gpr[p.args.D.ra] = proc.cpu.gpr[p.args.D.rt] & (p.args.D.d << 16);
  ...
  PseudoStatus ppc_cmp(PPC_Processor &proc, const PPC_PseudoInstruction& p) {
    ...
    const int32_t a = proc.cpu.gpr[p.args.X.ra];
    const int32_t b = proc.cpu.gpr[p.args.X.rb];
    uint32_t c, bf;
  ...
  PseudoStatus ppc_cmpli(PPC_Processor &proc, const PPC_PseudoInstruction& p) {
    ...
    const uint32_t a = proc.cpu.gpr[p.args.D.ra];
    const uint32_t b = p.args.D.d;
    uint32_t c, bf;
 ...
 /*--------------------------------------------------------------------------*/
  PseudoStatus ppc_cntlzw(PPC_Processor &proc, const PPC_PseudoInstruction& p) {
    proc.debug() <<"ppcpi_cntlzw\n";
     ...
     uint32_t v = proc.cpu.gpr[p.args.X.rt];
    while (!(v & x)) {
      n++;
      if (n == 32)
        break;
  ...
  PseudoStatus ppc_crand(PPC_Processor &proc, const PPC_PseudoInstruction& p) {
    ...
    if ((proc.cpu.cr & (1<<(31-p.args.XL.ba))) && (proc.cpu.cr & (1<<(31-p.args.XL.bb))))
      proc.cpu.cr |= (1<<(31-p.args.XL.bt));
    else
      proc.cpu.cr &= ~(1<<(31-p.args.XL.bt));
  ...
  PseudoStatus ppc_creqv(PPC_Processor &proc, const PPC_PseudoInstruction& p) {
    ...
    if (((proc.cpu.cr & (1<<(31-p.args.XL.ba))) && (proc.cpu.cr & (1<<(31-p.args.XL.bb))))
        || (!(proc.cpu.cr & (1<<(31-p.args.XL.ba))) && !(proc.cpu.cr & (1<<(31-p.args.XL.bb)))))
      proc.cpu.cr |= (1<<(31-p.args.XL.bt));
    else
      proc.cpu.cr &= ~(1<<(31-p.args.XL.bt));
...
/*--------------------------------------------------------------------------*/
  ...
  PseudoStatus ppc_divw(PPC_Processor &proc, const PPC_PseudoInstruction& p) {
    ...
    if (!proc.cpu.gpr[p.args.X.rb]) {
      error()<<"div instruction invalid!\n";
    }

    int32_t a = proc.cpu.gpr[p.args.X.ra];
    int32_t b = proc.cpu.gpr[p.args.X.rb];
    proc.cpu.gpr[p.args.X.rt] = a / b;
...
/*--------------------------------------------------------------------------*/
  PseudoStatus ppc_divwu(PPC_Processor &proc, const PPC_PseudoInstruction& p) {
    ...
    proc.cpu.gpr[p.args.X.rt] = proc.cpu.gpr[p.args.X.ra] / proc.cpu.gpr[p.args.X.rb];
    return OK;
  }
  ...
  PseudoStatus ppc_divwuo(PPC_Processor &proc, const PPC_PseudoInstruction& p) {
    ...
    uint32_t b = proc.cpu.gpr[p.args.X.rb];
    if (!b) {
      error()<<"div instruction invalid!\n";
    }

    proc.cpu.gpr[p.args.X.rt] = proc.cpu.gpr[p.args.X.ra] / b;
    if(b==0)
      proc.cpu.xer |= (XER_SO | XER_OV);//FIXME
    else
      proc.cpu.xer &= ~XER_OV;
  ...
  PseudoStatus ppc_dcbz_ra0(PPC_Processor &proc, const PPC_PseudoInstruction& p) {
    ...
    uint32_t addr = proc.cpu.gpr[p.args.X.rb];
    assert((addr&0x3) == 0);
    for(int i = 0; i < 8; i++)
   ...
   PseudoStatus ppc_dcbz_raS(PPC_Processor &proc, const PPC_PseudoInstruction& p) {
    ...
    //PPC_L1_CACHE_LINE_SIZE=32
    uint32_t addr = proc.cpu.gpr[p.args.X.ra] +  proc.cpu.gpr[p.args.X.rb];
    assert((addr&0x3) == 0);
    for(int i = 0; i < 8; i++)
      proc.mmu.write_word(addr+i*4, 0);
  ...
  PseudoStatus ppc_extsb(PPC_Processor &proc, const PPC_PseudoInstruction& p) {
    ...
    proc.cpu.gpr[p.args.X.ra] = proc.cpu.gpr[p.args.X.rt];
    if (proc.cpu.gpr[p.args.X.ra] & 0x80)
      proc.cpu.gpr[p.args.X.ra] |= 0xffffff00;
    else
      proc.cpu.gpr[p.args.X.ra] &= ~0xffffff00;
    return OK;
  }
  ...
  PseudoStatus ppc_extsh(PPC_Processor &proc, const PPC_PseudoInstruction& p) {
    ...
    proc.cpu.gpr[p.args.X.ra] = proc.cpu.gpr[p.args.X.rt];
    if (proc.cpu.gpr[p.args.X.ra] & 0x8000)
      proc.cpu.gpr[p.args.X.ra] |= 0xffff0000;
    else
      proc.cpu.gpr[p.args.X.ra] &= ~0xffff0000;
    return OK;
  }
 ...
 /*--------------------------------------------------------------------------*/
  ...
  PseudoStatus ppc_stwu(PPC_Processor &proc, const PPC_PseudoInstruction& p) {
    ...
    const uint32_t addr = proc.cpu.gpr[p.args.D.ra] + p.args.D.d;
    if ((addr&0x3) == 0) { //word valignment
      proc.mmu.write_word(addr, proc.cpu.gpr[p.args.D.rt]);
    } else {
      uint32_t data = proc.cpu.gpr[p.args.D.rt];
      for (int i = 0; i < 4; i++, data <<= 8) {
        proc.mmu.write_byte(addr+i, (uint8_t)(data>>24));
      }
    }
    proc.cpu.gpr[p.args.D.ra] = addr;
    return OK;
  }
  ...
  PseudoStatus ppc_stw_raS(PPC_Processor &proc, const PPC_PseudoInstruction& p) {
    ...
    uint32_t addr = proc.cpu.gpr[p.args.D.ra] + p.args.D.d;
    if ((addr & 0x3) == 0) { //word valignment
      proc.mmu.write_word(addr, proc.cpu.gpr[p.args.D.rt]);
    } else {
      int i;
  ...
  PseudoStatus ppc_stwbrx_ra0(PPC_Processor &proc, const PPC_PseudoInstruction& p) {
    proc.debug() <<"ppcpi_stwbrx_ra0\n";
     uint32_t addr = proc.cpu.gpr[p.args.X.rb];
    if((addr&0x3) == 0){ //word valignment
      proc.mmu.write_word(addr, word_be_le_translate(proc.cpu.gpr[p.args.X.rt]));
    } else {
      int i;
      uint32_t data = word_be_le_translate(proc.cpu.gpr[p.args.X.rt]);
      for(i = 0; i < 4; i++, data <<= 8) {
        proc.mmu.write_byte(addr+i, (uint8_t)(data>>24));
      }
    }
  ...
  PseudoStatus ppc_stwcx__ra0(PPC_Processor &proc, const PPC_PseudoInstruction& p) {
    ...
    if (proc.cpu.have_reservation) {
      ...
      addr = proc.cpu.gpr[p.args.X.rb];

      assert((addr&0x3) == 0);
      v = proc.mmu.read_word(addr);

      if (v == proc.cpu.reserve) {
        proc.mmu.write_word(addr, proc.cpu.gpr[p.args.X.rt]);
   ...
   PseudoStatus ppc_stwcx__raS(PPC_Processor &proc, const PPC_PseudoInstruction& p) {
    ...
    if (proc.cpu.have_reservation) {
      proc.cpu.have_reservation = false;
      addr = proc.cpu.gpr[p.args.X.ra] + proc.cpu.gpr[p.args.X.rb];
  ...
  PseudoStatus ppc_stwux(PPC_Processor &proc, const PPC_PseudoInstruction& p) {
    ...
    if((addr&0x3) == 0){ //word valignment
      ...
      int i;
      uint32_t data = proc.cpu.gpr[p.args.X.rt];
      for(i = 0; i < 4; i++, data <<= 8) {
        proc.mmu.write_byte(addr+i, (uint8_t)(data>>24));
      }
    }

    proc.cpu.gpr[p.args.X.ra] = addr;
    return OK;
  }
  ...
  PseudoStatus ppc_stfd_ra0(PPC_Processor &proc, const PPC_PseudoInstruction& p) {
    ...
    uint32_t addr = p.args.D.d;//d is already sign extended
    proc.mmu.write_double(addr,proc.cpu.fpr[p.args.D.rt]);

    //for debug
    double d = *reinterpret_cast<double*>(&proc.cpu.fpr[p.args.D.rt]);
    debug()<<"store :"<<d<<" ["<<hex<<proc.cpu.fpr[p.args.D.rt]<<"]"<<endl;
  ...
  PseudoStatus ppc_stfd_raS(PPC_Processor &proc, const PPC_PseudoInstruction& p) {
    ...
    proc.fp_unit.check_fp_enabled();
    uint32_t addr = proc.cpu.gpr[p.args.D.ra] + p.args.D.d;//d is already sign extended
    proc.mmu.write_double(addr,proc.cpu.fpr[p.args.D.rt]);
  ...
  PseudoStatus ppc_stfdux(PPC_Processor &proc, const PPC_PseudoInstruction& p) {
    ...
    uint32_t addr = proc.cpu.gpr[p.args.X.ra] + proc.cpu.gpr[p.args.X.rb] ;
    proc.mmu.write_double(addr,proc.cpu.fpr[p.args.X.rt]);
    proc.cpu.gpr[p.args.X.ra] = addr;

    //for debug
    double d = *reinterpret_cast<double*>(&proc.cpu.fpr[p.args.X.rt]);
    debug()<<"store :"<< d<<" ["<<hex<<proc.cpu.fpr[p.args.X.rt]<<"]"<<endl;
    return OK;
  }
  ...
  PseudoStatus ppc_stfiwx_ra0(PPC_Processor &proc, const PPC_PseudoInstruction& p) {
    ...
    proc.fp_unit.check_fp_enabled();
    uint32_t addr = proc.cpu.gpr[p.args.X.rb] ;
    proc.mmu.write_word(addr, (uint32_t) proc.cpu.fpr[p.args.X.rt]);
  ...
  PseudoStatus ppc_stfs_ra0(PPC_Processor &proc, const PPC_PseudoInstruction& p) {
    ...
    proc.fp_unit.check_fp_enabled();
    uint32_t addr = p.args.D.d;//d is already sign extended
    uint32_t data = fp_t::single_format(proc.cpu.fpr[p.args.D.rt]);
  ...
  PseudoStatus ppc_stfsux(PPC_Processor &proc, const PPC_PseudoInstruction& p) {
    ...
    uint32_t addr = proc.cpu.gpr[p.args.X.ra] + proc.cpu.gpr[p.args.X.rb];
    uint32_t data = fp_t::single_format(proc.cpu.fpr[p.args.X.rt]);
    proc.mmu.write_word(addr,data);
    proc.cpu.gpr[p.args.X.ra] = addr;
  ...
  PseudoStatus ppc_mfspr(PPC_Processor &proc, const PPC_PseudoInstruction& p) {
    ...
    int tmp =   ((p.args.XFX.spr & 0x1f) << 5) | ((p.args.XFX.spr >> 5) & 0x1f);

    switch(tmp) {//1,8,9 for User, or for Supervisor
    case    1 : proc.cpu.gpr[p.args.XFX.rt] = proc.cpu.xer;      break;
    case    8 : proc.cpu.gpr[p.args.XFX.rt] = proc.cpu.lr;       break;
    case    9 : proc.cpu.gpr[p.args.XFX.rt] = proc.cpu.ctr;      break;
    case   18 : proc.cpu.gpr[p.args.XFX.rt] = proc.cpu.dsisr;    break;
    case   19 : proc.cpu.gpr[p.args.XFX.rt] = proc.cpu.dar;      break;
    case   22 : proc.cpu.dec     = proc.cpu.pdec / PPC_CPU::TBF_RATIO;
      proc.cpu.gpr[p.args.XFX.rt] = proc.cpu.dec;      break;
    case   25 : proc.cpu.gpr[p.args.XFX.rt] = proc.cpu.sdr1;     break;
    case   26 : proc.cpu.gpr[p.args.XFX.rt] = proc.cpu.srr[0];   break;
    case   27 : proc.cpu.gpr[p.args.XFX.rt] = proc.cpu.srr[1];   break;
    case  256 : proc.cpu.gpr[p.args.XFX.rt] = proc.cpu.vrsave;   break;
    case  272 : proc.cpu.gpr[p.args.XFX.rt] = proc.cpu.sprg[0];  break;
    case  273 : proc.cpu.gpr[p.args.XFX.rt] = proc.cpu.sprg[1];  break;
    case  274 : proc.cpu.gpr[p.args.XFX.rt] = proc.cpu.sprg[2];  break;
    case  275 : proc.cpu.gpr[p.args.XFX.rt] = proc.cpu.sprg[3];  break;
    case  282 : proc.cpu.gpr[p.args.XFX.rt] = proc.cpu.ear;      break;
    case  286 : proc.cpu.gpr[p.args.XFX.rt] = proc.cpu.svr;      break;
    case  287 : proc.cpu.gpr[p.args.XFX.rt] = proc.cpu.pvr;      break;
    case  528 : proc.cpu.gpr[p.args.XFX.rt] = proc.cpu.ibatu[0]; break;
    case  529 : proc.cpu.gpr[p.args.XFX.rt] = proc.cpu.ibatl[0]; break;
    case  530 : proc.cpu.gpr[p.args.XFX.rt] = proc.cpu.ibatu[1]; break;
    case  531 : proc.cpu.gpr[p.args.XFX.rt] = proc.cpu.ibatl[1]; break;
    case  532 : proc.cpu.gpr[p.args.XFX.rt] = proc.cpu.ibatu[2]; break;
    case  533 : proc.cpu.gpr[p.args.XFX.rt] = proc.cpu.ibatl[2]; break;
    case  534 : proc.cpu.gpr[p.args.XFX.rt] = proc.cpu.ibatu[3]; break;
    case  535 : proc.cpu.gpr[p.args.XFX.rt] = proc.cpu.ibatl[3]; break;
    case  536 : proc.cpu.gpr[p.args.XFX.rt] = proc.cpu.dbatu[0]; break;
    case  537 : proc.cpu.gpr[p.args.XFX.rt] = proc.cpu.dbatl[0]; break;
    case  538 : proc.cpu.gpr[p.args.XFX.rt] = proc.cpu.dbatu[1]; break;
    case  539 : proc.cpu.gpr[p.args.XFX.rt] = proc.cpu.dbatl[1]; break;
    case  540 : proc.cpu.gpr[p.args.XFX.rt] = proc.cpu.dbatu[2]; break;
    case  541 : proc.cpu.gpr[p.args.XFX.rt] = proc.cpu.dbatl[2]; break;
    case  542 : proc.cpu.gpr[p.args.XFX.rt] = proc.cpu.dbatu[3]; break;
    case  543 : proc.cpu.gpr[p.args.XFX.rt] = proc.cpu.dbatl[3]; break;
    case  560 : proc.cpu.gpr[p.args.XFX.rt] = proc.cpu.ibatu[4]; break;
    case  561 : proc.cpu.gpr[p.args.XFX.rt] = proc.cpu.ibatl[4]; break;
    case  562 : proc.cpu.gpr[p.args.XFX.rt] = proc.cpu.ibatu[5]; break;
    case  563 : proc.cpu.gpr[p.args.XFX.rt] = proc.cpu.ibatl[5]; break;
    case  564 : proc.cpu.gpr[p.args.XFX.rt] = proc.cpu.ibatu[6]; break;
    case  565 : proc.cpu.gpr[p.args.XFX.rt] = proc.cpu.ibatl[6]; break;
    case  566 : proc.cpu.gpr[p.args.XFX.rt] = proc.cpu.ibatu[7]; break;
    case  567 : proc.cpu.gpr[p.args.XFX.rt] = proc.cpu.ibatl[7]; break;
    case  568 : proc.cpu.gpr[p.args.XFX.rt] = proc.cpu.dbatu[4]; break;
    case  569 : proc.cpu.gpr[p.args.XFX.rt] = proc.cpu.dbatl[4]; break;
    case  570 : proc.cpu.gpr[p.args.XFX.rt] = proc.cpu.dbatu[5]; break;
    case  571 : proc.cpu.gpr[p.args.XFX.rt] = proc.cpu.dbatl[5]; break;
    case  572 : proc.cpu.gpr[p.args.XFX.rt] = proc.cpu.dbatu[6]; break;
    case  573 : proc.cpu.gpr[p.args.XFX.rt] = proc.cpu.dbatl[6]; break;
    case  574 : proc.cpu.gpr[p.args.XFX.rt] = proc.cpu.dbatu[7]; break;
    case  575 : proc.cpu.gpr[p.args.XFX.rt] = proc.cpu.dbatl[7]; break;
    case 1008 : proc.cpu.gpr[p.args.XFX.rt] = proc.cpu.hid[0];   break;
    case 1009 : proc.cpu.gpr[p.args.XFX.rt] = proc.cpu.hid[1];   break;
    case 1011 : proc.cpu.gpr[p.args.XFX.rt] = proc.cpu.ictrl;    break;
    case 1012 : proc.cpu.gpr[p.args.XFX.rt] = proc.cpu.ldstdb;   break;
    case 1013 : proc.cpu.gpr[p.args.XFX.rt] = proc.cpu.dabr;     break;
    case 1014 : proc.cpu.gpr[p.args.XFX.rt] = proc.cpu.msscr0;   break;
    case 1015 : proc.cpu.gpr[p.args.XFX.rt] = proc.cpu.msssr0;   break;
    case 1016 : proc.cpu.gpr[p.args.XFX.rt] = proc.cpu.ldstcr;   break;
    case 1017 : /*proc.cpu.gpr[p.args.XFX.rt] = proc.cpu.l2cr;*/ break;
    case 1019 : proc.cpu.gpr[p.args.XFX.rt] = proc.cpu.ictc;     break;
    case 1023 : proc.cpu.gpr[p.args.XFX.rt] = proc.cpu.pir;      break;
    default:
  ...
  PseudoStatus ppc_mtcrf(PPC_Processor &proc, const PPC_PseudoInstruction& p) {
    ...
    uint32_t tmp, tmp1 = (p.args.XFX.spr >> 1) & 0xff;
    ...
    proc.cpu.cr = (proc.cpu.gpr[p.args.XFX.rt] & tmp) | (proc.cpu.cr & ~tmp);
    return OK;
  }
  ...
  PseudoStatus ppc_mfcr(PPC_Processor &proc, const PPC_PseudoInstruction& p) {
    ...
    proc.cpu.gpr[p.args.X.rt] = proc.cpu.cr;
    return OK;
  }
  ...
  PseudoStatus ppc_mfmsr(PPC_Processor &proc, const PPC_PseudoInstruction& p) {
    ...
    proc.cpu.gpr[p.args.X.rt] = proc.cpu.msr;
    return OK;
  }
  ...
  PseudoStatus ppc_mfsr(PPC_Processor &proc, const PPC_PseudoInstruction& p) {
    ...
    proc.cpu.gpr[p.args.X.rt] = proc.cpu.sr[p.args.X.ra & 0xf];
    return OK;
  }
  ...
  PseudoStatus ppc_mftb(PPC_Processor &proc, const PPC_PseudoInstruction& p) {
    ...
    uint16_t n = ((p.args.XFX.spr & 0x1f) << 5) | ((p.args.XFX.spr >> 5) & 0x1f);
    if(n == 268)
      proc.cpu.gpr[p.args.XFX.rt]= proc.cpu.tbr._tbr[0];
    else if(n == 269)
      proc.cpu.gpr[p.args.XFX.rt]= proc.cpu.tbr._tbr[1];
    else {
      cout<<"ppcpi_mftb error : "<<n<<hex<<" spr : "<<p.args.XFX.spr<<endl;
      exit(-1);
    }
    return OK;
  }
  ...
  PseudoStatus ppc_mfsrin(PPC_Processor &proc, const PPC_PseudoInstruction& p) {
    ...
    proc.cpu.gpr[p.args.X.rt] = proc.cpu.sr[proc.cpu.gpr[p.args.X.rb] >> 28];
    return OK;
  }
  ...
  PseudoStatus ppc_mcrf(PPC_Processor &proc, const PPC_PseudoInstruction& p) {
    ...
    int bf = p.args.XL.bt >> 2;
    int bfa = p.args.XL.ba >> 2;
    bf = 7-bf;
    bfa = 7-bfa;
  ...
  PseudoStatus ppc_mcrfs(PPC_Processor &proc, const PPC_PseudoInstruction& p) {
    ...
    proc.fp_unit.check_fp_enabled();
    uint8_t crfD = p.args.X.rt>>2;
    uint8_t crfS = p.args.X.ra>>2;
  ...
  PseudoStatus ppc_mffs(PPC_Processor &proc, const PPC_PseudoInstruction& p) {
    ...
    proc.fp_unit.check_fp_enabled();
    proc.cpu.fpr[p.args.X.rt] = proc.fp_unit.fpscr.get_value();
    return OK;
  }
  ...
  PseudoStatus ppc_mtmsr(PPC_Processor &proc, const PPC_PseudoInstruction& p) {
    ...
    proc.cpu.msr = proc.cpu.gpr[p.args.X.rt];
    proc.signal();
    return OK;
  }
  ...
  PseudoStatus ppc_mtsr(PPC_Processor &proc, const PPC_PseudoInstruction& p) {
    ...
    proc.cpu.sr[p.args.X.ra & 0xf] = proc.cpu.gpr[p.args.X.rt];
    return OK;
  }
  ...
  PseudoStatus ppc_mtsrin(PPC_Processor &proc, const PPC_PseudoInstruction& p) {
    ...
    proc.cpu.sr[proc.cpu.gpr[p.args.X.rb] >> 28] = proc.cpu.gpr[p.args.X.rt];
    return OK;
  }
  ...
  PseudoStatus ppc_mtfsb0(PPC_Processor &proc, const PPC_PseudoInstruction& p) {
    ...
    proc.fp_unit.check_fp_enabled();
    proc.fp_unit.fpscr.set_bit(p.args.X.rt,false);
    return OK;
  }
  ...
  PseudoStatus ppc_mtfsb1(PPC_Processor &proc, const PPC_PseudoInstruction& p) {
    ...
    proc.fp_unit.check_fp_enabled();
    proc.fp_unit.fpscr.set_bit(p.args.X.rt,true);
    return OK;
  }
  ...
  PseudoStatus ppc_mtfsf(PPC_Processor &proc, const PPC_PseudoInstruction& p) {
    ...
    uint32_t value = (uint32_t)proc.cpu.fpr[p.args.XFL.frb];
    for(int8_t field=7;field>=0;field--){
      if(p.args.XFL.flm & (0x1<<(7-field))){
...
/*------------------------------------------------------------------------*/
  ...
  PseudoStatus ppc_lfd_ra0(PPC_Processor &proc, const PPC_PseudoInstruction& p) {
    ...
    proc.fp_unit.check_fp_enabled();
    uint32_t addr = p.args.D.d;//d is already sign extended
    proc.cpu.fpr[p.args.D.rt] = proc.mmu.read_double(addr);

    //for debug
    double d = *reinterpret_cast<double*>(&proc.cpu.fpr[p.args.D.rt]);
    debug()<<"load :"<< d<<" ["<<hex<<proc.cpu.fpr[p.args.D.rt]<<"]"<<endl;
  ...
  PseudoStatus ppc_lfdux(PPC_Processor &proc, const PPC_PseudoInstruction& p) {
    ...
    uint32_t addr = proc.cpu.gpr[p.args.X.ra] + proc.cpu.gpr[p.args.X.rb];
    proc.cpu.fpr[p.args.X.rt] = proc.mmu.read_double(addr);
    proc.cpu.gpr[p.args.X.ra] = addr;

    //for debug
    double d = *reinterpret_cast<double*>(&proc.cpu.fpr[p.args.X.rt]);
    debug()<<"load :"<< d<<" ["<<hex<<proc.cpu.fpr[p.args.X.rt]<<"]"<<endl;
    return OK;
  }
 ...
 /*------------------------------------------------------------------------*/
  PseudoStatus ppc_lfs_ra0(PPC_Processor &proc, const PPC_PseudoInstruction& p) {
    ...
    proc.fp_unit.check_fp_enabled();
    uint32_t addr = p.args.D.d;//d is already sign extened
    uint32_t single_format = proc.mmu.read_word(addr);
    proc.cpu.fpr[p.args.D.rt] = fp_t::double_format(single_format);
  ...
  PseudoStatus ppc_lfs_raS(PPC_Processor &proc, const PPC_PseudoInstruction& p) {
    ...
    proc.fp_unit.check_fp_enabled();
    uint32_t addr = proc.cpu.gpr[p.args.D.ra] + p.args.D.d;//d is already sign extened
    uint32_t single_format = proc.mmu.read_word(addr);
    proc.cpu.fpr[p.args.D.rt] = fp_t::double_format(single_format);
...
/*------------------------------------------------------------------------*/
  ...
  PseudoStatus ppc_lfsux(PPC_Processor &proc, const PPC_PseudoInstruction& p) {
    ...
    uint32_t addr = proc.cpu.gpr[p.args.X.ra] + proc.cpu.gpr[p.args.X.rb];
    uint32_t single_format = proc.mmu.read_word(addr);
    proc.cpu.fpr[p.args.X.rt] = fp_t::double_format(single_format);
    proc.cpu.gpr[p.args.X.ra] = addr;
  ...
  PseudoStatus ppc_lwz_ra0(PPC_Processor &proc, const PPC_PseudoInstruction& p) {
    ...
    const uint32_t addr =  p.args.D.d;
    if((addr&0x3) == 0){ //word valignment
      proc.cpu.gpr[p.args.D.rt] = proc.mmu.read_word(addr);
    } else {
      int i;
      uint32_t data = 0;
  ...
  PseudoStatus ppc_lwzux(PPC_Processor &proc, const PPC_PseudoInstruction& p) {
    ...
    if((addr&0x3) == 0){ //word valignment
      proc.cpu.gpr[p.args.X.rt] = proc.mmu.read_word(addr);
    } else {
      int i;
      uint32_t data = 0;
      for(i = 0; i < 3; i++, data <<= 8) {
...
/*-------------------------------------------------------------------------------*/
  ...
  PseudoStatus ppc_neg(PPC_Processor &proc, const PPC_PseudoInstruction& p) {
    ...
    proc.cpu.gpr[p.args.X.rt] = -proc.cpu.gpr[p.args.X.ra];
    return OK;
  }
  ...
  PseudoStatus ppc_cmpi(PPC_Processor &proc, const PPC_PseudoInstruction& p) {
    ...
    const int32_t a = proc.cpu.gpr[p.args.D.ra];
    const int32_t b = p.args.D.d;
    uint32_t c, bf;
  ...
  PseudoStatus ppc_bc_bo00_bo20(PPC_Processor &proc, const PPC_PseudoInstruction& p) {
    ...
    bool bo2 = (p.args.B.bo & 2);
    bool bo8 = (p.args.B.bo & 8);
    bool cr = (proc.cpu.cr & (1<<(31-p.args.B.bi)));

    if ((((proc.cpu.ctr != 0) ^ bo2)) && ( (!(cr ^ bo8)))) {
      proc.cpu.pc += p.args.B.bd;
      return BRANCH;
    } else
      return OK;
  }
  ...
  PseudoStatus ppc_bcctr_bo00(PPC_Processor &proc, const PPC_PseudoInstruction& p) {
    ...
    bool bt8 = (p.args.XL.bt & 8);
    bool cr = (proc.cpu.cr & (1<<(31-p.args.XL.ba)));
  ...
  PseudoStatus ppc_addis_ra0(PPC_Processor &proc, const PPC_PseudoInstruction& p) {
    ...
    proc.cpu.gpr[p.args.D.rt] = p.args.D.d << 16;
    return OK;
  }

  PseudoStatus ppc_addis_raS(PPC_Processor &proc, const PPC_PseudoInstruction& p) {
    proc.debug() <<"ppcpi_addis_raS\n";
    proc.cpu.gpr[p.args.D.rt] = proc.cpu.gpr[p.args.D.ra] + (p.args.D.d << 16);
    return OK;
  }
  ...
  PseudoStatus ppc_stb_ra0(PPC_Processor &proc, const PPC_PseudoInstruction& p) {
    ...
    const uint32_t addr = p.args.D.d;
    proc.mmu.write_byte(addr, (uint8_t) proc.cpu.gpr[p.args.D.rt]);
    return OK;
  }
  ...
  PseudoStatus ppc_stbux(PPC_Processor &proc, const PPC_PseudoInstruction& p) {
    ...
    uint32_t addr = proc.cpu.gpr[p.args.X.ra] + proc.cpu.gpr[p.args.X.rb];
    proc.mmu.write_byte(addr, (uint8_t) proc.cpu.gpr[p.args.X.rt]);
    proc.cpu.gpr[p.args.X.ra] = addr;
    return OK;
  }
  ...
  PseudoStatus ppc_sth_ra0(PPC_Processor &proc, const PPC_PseudoInstruction& p) {
    ...
    if((addr&0x1) == 0){ //half word valignment
      proc.mmu.write_half(addr, (uint16_t)proc.cpu.gpr[p.args.D.rt]);
    } else {
      proc.mmu.write_byte(addr, (uint8_t)(proc.cpu.gpr[p.args.D.rt]>>8));
      proc.mmu.write_byte(addr+1, (uint8_t)proc.cpu.gpr[p.args.D.rt]);
    }
  ...
  PseudoStatus ppc_sthbrx_ra0(PPC_Processor &proc, const PPC_PseudoInstruction& p) {
    ...
    if((addr&0x1) == 0){ //half word valignment
      proc.mmu.write_half(addr, half_be_le_translate((uint16_t) proc.cpu.gpr[p.args.X.rt]));
    } else {
      proc.mmu.write_byte(addr, (uint8_t)proc.cpu.gpr[p.args.X.rt]);
      proc.mmu.write_byte(addr+1, (uint8_t)(proc.cpu.gpr[p.args.X.rt]>>8));
    }
    return OK;
  }
 ...
 /*----------------------------------------------------------------------------*/
  ...
  PseudoStatus ppc_sthux(PPC_Processor &proc, const PPC_PseudoInstruction& p) {
    ...
    if((addr&0x1) == 0){ //half word valignment
      proc.mmu.write_half(addr, (uint16_t)proc.cpu.gpr[p.args.X.rt]);
    } else {
      proc.mmu.write_byte(addr, (uint8_t)(proc.cpu.gpr[p.args.X.rt]>>8));
      proc.mmu.write_byte(addr+1, (uint8_t)proc.cpu.gpr[p.args.X.rt]);
    }
  ...
  PseudoStatus ppc_stswi_ra0(PPC_Processor &proc, const PPC_PseudoInstruction& p) {
    ...
    uint32_t addr = 0;
    uint32_t r = 0, tmp_rt = p.args.X.rt;
    int i;
    uint8_t nb = p.args.X.rb;
    if (nb==0)
      nb = 32;
   ...
   PseudoStatus ppc_stswi_raS(PPC_Processor &proc, const PPC_PseudoInstruction& p) {
    ...
    uint32_t addr = proc.cpu.gpr[p.args.X.ra];
    uint32_t r = 0, tmp_rt = p.args.X.rt;
    int i;
    uint8_t nb = p.args.X.rb;
    if (nb==0)
  ...
  PseudoStatus ppc_mtspr(PPC_Processor &proc, const PPC_PseudoInstruction& p) {
    ...
    int tmp = ((p.args.XFX.spr & 0x1f) << 5) | ((p.args.XFX.spr >> 5) & 0x1f);
    switch(tmp) {//1,8,9 for User, or for Supervisor
    case    1 : proc.cpu.xer      = proc.cpu.gpr[p.args.XFX.rt]; break;
    case    8 : proc.cpu.lr       = proc.cpu.gpr[p.args.XFX.rt]; break;
    case    9 : proc.cpu.ctr      = proc.cpu.gpr[p.args.XFX.rt]; break;
    case   18 : proc.cpu.dsisr    = proc.cpu.gpr[p.args.XFX.rt]; break;
    case   19 : proc.cpu.dar      = proc.cpu.gpr[p.args.XFX.rt]; break;
    case   22 : proc.cpu.dec      = proc.cpu.gpr[p.args.XFX.rt];
      proc.cpu.pdec     = proc.cpu.dec;
      proc.cpu.pdec  *= PPC_CPU::TBF_RATIO; break;
    case   25 : proc.cpu.sdr1     = proc.cpu.gpr[p.args.XFX.rt]; break;
    case   26 : proc.cpu.srr[0]   = proc.cpu.gpr[p.args.XFX.rt]; break;
    case   27 : proc.cpu.srr[1]   = proc.cpu.gpr[p.args.XFX.rt]; break;
    case  256 : proc.cpu.vrsave   = proc.cpu.gpr[p.args.XFX.rt]; break;
    case  272 : proc.cpu.sprg[0]  = proc.cpu.gpr[p.args.XFX.rt]; break;
    case  273 : proc.cpu.sprg[1]  = proc.cpu.gpr[p.args.XFX.rt]; break;
    case  274 : proc.cpu.sprg[2]  = proc.cpu.gpr[p.args.XFX.rt]; break;
    case  275 : proc.cpu.sprg[3]  = proc.cpu.gpr[p.args.XFX.rt]; break;
    case  282 : proc.cpu.ear      = proc.cpu.gpr[p.args.XFX.rt]; break;
    case  284 :
      {
        proc.cpu.tbr._tbr[0] = proc.cpu.gpr[p.args.XFX.rt];
        proc.cpu.ptbr = proc.cpu.tbr.tbr;
        break;
      }
    case  285 :
      {
        proc.cpu.tbr._tbr[1] = proc.cpu.gpr[p.args.XFX.rt];
        proc.cpu.ptbr = proc.cpu.tbr.tbr;
        break;
      }

    case  528 : proc.cpu.ibatu[0] = proc.cpu.gpr[p.args.XFX.rt]; break;
    case  529 : proc.cpu.ibatl[0] = proc.cpu.gpr[p.args.XFX.rt]; break;
    case  530 : proc.cpu.ibatu[1] = proc.cpu.gpr[p.args.XFX.rt]; break;
    case  531 : proc.cpu.ibatl[1] = proc.cpu.gpr[p.args.XFX.rt]; break;
    case  532 : proc.cpu.ibatu[2] = proc.cpu.gpr[p.args.XFX.rt]; break;
    case  533 : proc.cpu.ibatl[2] = proc.cpu.gpr[p.args.XFX.rt]; break;
    case  534 : proc.cpu.ibatu[3] = proc.cpu.gpr[p.args.XFX.rt]; break;
    case  535 : proc.cpu.ibatl[3] = proc.cpu.gpr[p.args.XFX.rt]; break;
    case  536 : proc.cpu.dbatu[0] = proc.cpu.gpr[p.args.XFX.rt]; break;
    case  537 : proc.cpu.dbatl[0] = proc.cpu.gpr[p.args.XFX.rt]; break;
    case  538 : proc.cpu.dbatu[1] = proc.cpu.gpr[p.args.XFX.rt]; break;
    case  539 : proc.cpu.dbatl[1] = proc.cpu.gpr[p.args.XFX.rt]; break;
    case  540 : proc.cpu.dbatu[2] = proc.cpu.gpr[p.args.XFX.rt]; break;
    case  541 : proc.cpu.dbatl[2] = proc.cpu.gpr[p.args.XFX.rt]; break;
    case  542 : proc.cpu.dbatu[3] = proc.cpu.gpr[p.args.XFX.rt]; break;
    case  543 : proc.cpu.dbatl[3] = proc.cpu.gpr[p.args.XFX.rt]; break;
    case  560 : proc.cpu.ibatu[4] = proc.cpu.gpr[p.args.XFX.rt]; break;
    case  561 : proc.cpu.ibatl[4] = proc.cpu.gpr[p.args.XFX.rt]; break;
    case  562 : proc.cpu.ibatu[5] = proc.cpu.gpr[p.args.XFX.rt]; break;
    case  563 : proc.cpu.ibatl[5] = proc.cpu.gpr[p.args.XFX.rt]; break;
    case  564 : proc.cpu.ibatu[6] = proc.cpu.gpr[p.args.XFX.rt]; break;
    case  565 : proc.cpu.ibatl[6] = proc.cpu.gpr[p.args.XFX.rt]; break;
    case  566 : proc.cpu.ibatu[7] = proc.cpu.gpr[p.args.XFX.rt]; break;
    case  567 : proc.cpu.ibatl[7] = proc.cpu.gpr[p.args.XFX.rt]; break;
    case  568 : proc.cpu.dbatu[4] = proc.cpu.gpr[p.args.XFX.rt]; break;
    case  569 : proc.cpu.dbatl[4] = proc.cpu.gpr[p.args.XFX.rt]; break;
    case  570 : proc.cpu.dbatu[5] = proc.cpu.gpr[p.args.XFX.rt]; break;
    case  571 : proc.cpu.dbatl[5] = proc.cpu.gpr[p.args.XFX.rt]; break;
    case  572 : proc.cpu.dbatu[6] = proc.cpu.gpr[p.args.XFX.rt]; break;
    case  573 : proc.cpu.dbatl[6] = proc.cpu.gpr[p.args.XFX.rt]; break;
    case  574 : proc.cpu.dbatu[7] = proc.cpu.gpr[p.args.XFX.rt]; break;
    case  575 : proc.cpu.dbatl[7] = proc.cpu.gpr[p.args.XFX.rt]; break;
    case 1008 : proc.cpu.hid[0]   = proc.cpu.gpr[p.args.XFX.rt]; break;
    case 1009 : proc.cpu.hid[1]   = proc.cpu.gpr[p.args.XFX.rt]; break;
    case 1011 : proc.cpu.ictrl    = proc.cpu.gpr[p.args.XFX.rt]; break;
    case 1012 : proc.cpu.ldstdb   = proc.cpu.gpr[p.args.XFX.rt]; break;
    case 1013 : proc.cpu.dabr     = proc.cpu.gpr[p.args.XFX.rt]; break;
    case 1014 : proc.cpu.msscr0   = proc.cpu.gpr[p.args.XFX.rt]; break;
    case 1015 : proc.cpu.msssr0   = proc.cpu.gpr[p.args.XFX.rt]; break;
    case 1016 : proc.cpu.ldstcr   = proc.cpu.gpr[p.args.XFX.rt]; break;
    case 1017 : /*proc.cpu.l2cr   = proc.cpu.gpr[p.args.XFX.rt];*/ break;
    case 1019 : proc.cpu.ictc   = proc.cpu.gpr[p.args.XFX.rt];   break;
    case 1023 : proc.cpu.pir      = proc.cpu.gpr[p.args.XFX.rt]; break;
    default:
  ...
  PseudoStatus ppc_bclr_bo00_bo20(PPC_Processor &proc, const PPC_PseudoInstruction& p) {
    ...
    bool bo2 = (p.args.XL.bt & 2);
    bool bo8 = (p.args.XL.bt & 8);
    bool cr = (proc.cpu.cr & (1<<(31-p.args.XL.ba)));
  ...
  PseudoStatus ppc_eieio(PPC_Processor &proc, const PPC_PseudoInstruction& p) {
    ...
    cout <<"executing EIEIO\n";
    // TODO("eieio"); // nothing to do at our abstraction level
    return OK;
  }
  ...
  PseudoStatus ppc_icbi(PPC_Processor &proc, const PPC_PseudoInstruction& p) {
    ...
    cout <<"executing ICBI\n";
    // TODO("icbi"); // we do not simulate the cache
    return OK;
  }
  ...
  PseudoStatus ppc_isync(PPC_Processor &proc, const PPC_PseudoInstruction& p) {
    ...
    cout <<"executing ISYNC\n";
    // We do not simulate the cache, so sync has nothing to do
    // TODO("isync");
  ...
  PseudoStatus ppc_lbz_ra0(PPC_Processor &proc, const PPC_PseudoInstruction& p) {
    ...
    const uint32_t addr = p.args.D.d;
    proc.cpu.gpr[p.args.D.rt] = (uint32_t) proc.mmu.read_byte(addr);
    return OK;
  }
  ...
  PseudoStatus ppc_lbzux(PPC_Processor &proc, const PPC_PseudoInstruction& p) {
    ...
    const uint32_t addr = proc.cpu.gpr[p.args.X.ra] +  proc.cpu.gpr[p.args.X.rb];
    proc.cpu.gpr[p.args.X.rt] = (uint32_t) proc.mmu.read_byte(addr);
    proc.cpu.gpr[p.args.X.ra] = addr;
    return OK;
  }
  ...
  PseudoStatus ppc_lbzx_ra0(PPC_Processor &proc, const PPC_PseudoInstruction& p) {
    ...
    const uint32_t addr =  proc.cpu.gpr[p.args.X.rb];
    proc.cpu.gpr[p.args.X.rt] = (uint32_t) proc.mmu.read_byte(addr);
    return OK;
  }
  ...
  PseudoStatus ppc_rlwimi(PPC_Processor &proc, const PPC_PseudoInstruction& p) {
    ...
    const uint32_t v = ppc_word_rotl(proc.cpu.gpr[p.args.M.rs],p.args.M.rb);
    const uint32_t mask = ppc_mask(p.args.M.mb, p.args.M.me);
    proc.cpu.gpr[p.args.M.ra] = (v & mask) | (proc.cpu.gpr[p.args.M.ra] & ~mask);
    return OK;
  }
  ...
  PseudoStatus ppc_rlwimi_(PPC_Processor &proc, const PPC_PseudoInstruction& p) {
    ...
    const uint32_t mask = ppc_mask(p.args.M.mb, p.args.M.me);
   proc.cpu.gpr[p.args.M.ra] = (v & mask) | (proc.cpu.gpr[p.args.M.ra] & ~mask);
    ppc_update_cr0(proc, p.args.M.ra);
    return OK;
  }
  ...
  PseudoStatus ppc_rlwinm(PPC_Processor &proc, const PPC_PseudoInstruction& p) {
    ...
    const uint32_t v = ppc_word_rotl(proc.cpu.gpr[p.args.M.rs],p.args.M.rb);
    const uint32_t mask = ppc_mask(p.args.M.mb, p.args.M.me);
    proc.cpu.gpr[p.args.M.ra] = v & mask;
    return OK;
  }
  ...
  PseudoStatus ppc_rlwnm(PPC_Processor &proc, const PPC_PseudoInstruction& p) {
    ...
    const uint32_t v = ppc_word_rotl(proc.cpu.gpr[p.args.M.rs],proc.cpu.gpr[p.args.M.rb]);
    const uint32_t mask = ppc_mask(p.args.M.mb, p.args.M.me);
    proc.cpu.gpr[p.args.M.ra] = v & mask;
    return OK;
  }
  ...
  PseudoStatus ppc_subf(PPC_Processor &proc, const PPC_PseudoInstruction& p) {
    ...
    proc.cpu.gpr[p.args.X.rt] = ~proc.cpu.gpr[p.args.X.ra] + proc.cpu.gpr[p.args.X.rb] + 1;
    return OK;
  }
  ...
  PseudoStatus ppc_subfc(PPC_Processor &proc, const PPC_PseudoInstruction& p) {
    ...
    const uint32_t a = proc.cpu.gpr[p.args.X.ra];
    const uint32_t b = proc.cpu.gpr[p.args.X.rb];
    proc.cpu.gpr[p.args.X.rt] = ~a + b + 1;
    // update xer
    if (ppc_carry(~a, b, 1))
      proc.cpu.xer |= XER_CA;
    else
  ...
  PseudoStatus ppc_subfco(PPC_Processor &proc, const PPC_PseudoInstruction& p) {
    ...
    if((b ^ a) & (b^proc.cpu.gpr[p.args.X.rt]) >> 31)
      proc.cpu.xer |= (XER_SO | XER_OV);//FIXME
    else
      proc.cpu.xer &= ~XER_OV;
  ...
  PseudoStatus ppc_subfe(PPC_Processor &proc, const PPC_PseudoInstruction& p) {
    ...
    const uint32_t b = proc.cpu.gpr[p.args.X.rb];
    const uint32_t ca = ((proc.cpu.xer & XER_CA) ? 1 : 0);
    proc.cpu.gpr[p.args.X.rt] = ~a + b + ca;
    // update xer
    if (ppc_carry(~a, b, ca))
      proc.cpu.xer |= XER_CA;
    else
 ...
 PseudoStatus ppc_subfeo(PPC_Processor &proc, const PPC_PseudoInstruction& p) {
    ...
    if (ppc_carry(~a, b, ca))
      ...
      proc.cpu.xer &= ~XER_CA;
    if((b ^ (a+ca)) & (b ^ proc.cpu.gpr[p.args.X.rt]) >> 31)
      proc.cpu.xer |= (XER_SO | XER_OV);//FIXME
    else
      proc.cpu.xer &= ~XER_OV;
 ...
 PseudoStatus ppc_subfeo_(PPC_Processor &proc, const PPC_PseudoInstruction& p) {
  ...
  PseudoStatus ppc_subfme(PPC_Processor &proc, const PPC_PseudoInstruction& p) {
    ...
    const uint32_t a = proc.cpu.gpr[p.args.X.ra];
    const uint32_t ca = ((proc.cpu.xer & XER_CA) ? 1 : 0);
    proc.cpu.gpr[p.args.X.rt] = ~a + ca + 0xffffffff;
    // update xer
    if ((a!=0xffffffff) || ca)
      proc.cpu.xer |= XER_CA;
    else
  ...
  PseudoStatus ppc_subfmeo(PPC_Processor &proc, const PPC_PseudoInstruction& p) {
    ...
    if ((a!=0xffffffff) || ca)
      ...
      proc.cpu.xer &= ~XER_CA;
    if((ca ^ (a + 0xffffffff)) & (ca ^ (proc.cpu.gpr[p.args.X.rt] + 1)) >> 31)
      proc.cpu.xer |= (XER_SO | XER_OV);//FIXME
    else
      proc.cpu.xer &= ~XER_OV;
  ...
  PseudoStatus ppc_subfzeo(PPC_Processor &proc, const PPC_PseudoInstruction& p) {
    ...
    if (!a & ca)
      ...
      proc.cpu.xer &= ~XER_CA;
    if((ca ^a ) & (ca ^ (proc.cpu.gpr[p.args.X.rt] + 1)) >> 31)
      proc.cpu.xer |= (XER_SO | XER_OV);//FIXME
    else
      proc.cpu.xer &= ~XER_OV;
  ...
  PseudoStatus ppc_subfic(PPC_Processor &proc, const PPC_PseudoInstruction& p) {
    ...
    const uint32_t a = proc.cpu.gpr[p.args.D.ra];
    proc.cpu.gpr[p.args.D.rt] = ~a + p.args.D.d + 1;

    // update XER
    if (ppc_carry(~a, p.args.D.d, 1))
      proc.cpu.xer |= XER_CA;
    else
      proc.cpu.xer &= ~XER_CA;
    return OK;
  ...
  PseudoStatus ppc_slw(PPC_Processor &proc, const PPC_PseudoInstruction& p) {
    ...
    uint32_t s = proc.cpu.gpr[p.args.X.rb] & 0x3f;
    if (s > 31)
      proc.cpu.gpr[p.args.X.ra] = 0;
    else
      proc.cpu.gpr[p.args.X.ra] = proc.cpu.gpr[p.args.X.rt] << s;
    return OK;
  }
  ...
  PseudoStatus ppc_tlbia(PPC_Processor &proc, const PPC_PseudoInstruction& p) {
    ...
    cout <<"executing TLBIA\n";
    // TODO("tlbia"); // nothing to do at our abstraction level
    return OK;
  }
  ...
  PseudoStatus ppc_tlbie(PPC_Processor &proc, const PPC_PseudoInstruction& p) {
    ...
    cout <<"executing TLBIE\n";
    // TODO("tlbie"); // nothing to do at our abstraction level
    return OK;
  }
  ...
  PseudoStatus ppc_tlbsync(PPC_Processor &proc, const PPC_PseudoInstruction& p) {
    ...
    cout <<"executing TLBSYNC\n";
    // TODO("tlbsync"); // nothing to do at our abstraction level
    return OK;
  }
  ...
  PseudoStatus ppc_tw(PPC_Processor &proc, const PPC_PseudoInstruction& p) {
    proc.debug() <<"ppcpi_tw\n";
    if(proc.debugger() && p.args.X.rt==12 && p.args.X.ra==p.args.X.rb)
  ...
  PseudoStatus ppc_twi(PPC_Processor &proc, const PPC_PseudoInstruction& p) {
    proc.debug() <<"ppcpi_tw\n";
    uint32_t a = proc.cpu.gpr[p.args.D.ra];
    if (((p.args.D.rt & 16) && ((int32_t)a < (int32_t)p.args.D.d))
        || ((p.args.D.rt & 8) && ((int32_t)a > (int32_t)p.args.D.d))
        || ((p.args.D.rt & 4) && ((int32_t)a == (int32_t)p.args.D.d))
        || ((p.args.D.rt & 2) && ((uint32_t)a < (uint32_t)p.args.D.d))
        || ((p.args.D.rt & 1) && ((uint32_t)a > (uint32_t)p.args.D.d))) {
  ...
  PseudoStatus ppc_srw(PPC_Processor &proc, const PPC_PseudoInstruction& p) {
    ...
    uint32_t v = proc.cpu.gpr[p.args.X.rb] & 0x3f;
    if (v > 31)
      proc.cpu.gpr[p.args.X.ra] = 0;
    else
      proc.cpu.gpr[p.args.X.ra] = proc.cpu.gpr[p.args.X.rt] >> v;
  ...
  PseudoStatus ppc_sraw(PPC_Processor &proc, const PPC_PseudoInstruction& p) {
    ...
    uint32_t SH = proc.cpu.gpr[p.args.X.rb] & 0x3f;
    proc.cpu.gpr[p.args.X.ra] = proc.cpu.gpr[p.args.X.rt];
    proc.cpu.xer &= ~XER_CA;
    if (proc.cpu.gpr[p.args.X.ra] & 0x80000000) {
      uint32_t ca = 0;
      for (uint32_t i = 0; i < SH; i++) {
        if (proc.cpu.gpr[p.args.X.ra] & 1)
          ca = 1;
        proc.cpu.gpr[p.args.X.ra] >>= 1;
        proc.cpu.gpr[p.args.X.ra] |= 0x80000000;
      }
  ...
  PseudoStatus ppc_srawi(PPC_Processor &proc, const PPC_PseudoInstruction& p) {
    ...
    if (proc.cpu.gpr[p.args.X.ra] & 0x80000000) {
      uint32_t ca = 0;
      for (uint32_t i = 0; i < p.args.X.rb; i++) {
        if (proc.cpu.gpr[p.args.X.ra] & 1)
          ca = 1;
        proc.cpu.gpr[p.args.X.ra] >>= 1;
        proc.cpu.gpr[p.args.X.ra] |= 0x80000000;
      ...
      if (p.args.X.rb > 31)
        ...
        proc.cpu.gpr[p.args.X.ra] >>= p.args.X.rb;
    }
  ...
  PseudoStatus ppc_lha_ra0(PPC_Processor &proc, const PPC_PseudoInstruction& p) {
    ...
    proc.cpu.gpr[p.args.D.rt] = (r & 0x8000) ? (r |0x0ffff0000) : r;
    return OK;
  }
  ...
  PseudoStatus ppc_lhaux(PPC_Processor &proc, const PPC_PseudoInstruction& p) {
    ...
    proc.cpu.gpr[p.args.X.rt] = (r & 0x8000) ? (r |0x0ffff0000) : r;
    proc.cpu.gpr[p.args.X.ra] = addr;
    return OK;
  }
  ...
  PseudoStatus ppc_lhbrx_ra0(PPC_Processor &proc, const PPC_PseudoInstruction& p) {
    ...
    if((addr&0x1) == 0){ //half word valignment
      proc.cpu.gpr[p.args.X.rt] = half_be_le_translate(proc.mmu.read_half(addr));
    } else {
      uint16_t data = 0;
      data |= proc.mmu.read_byte(addr);
      data <<= 8;
      data |= proc.mmu.read_byte(addr+1);
      proc.cpu.gpr[p.args.X.rt] = half_be_le_translate(data);
    }
  ...
  PseudoStatus ppc_lhz_ra0(PPC_Processor &proc, const PPC_PseudoInstruction& p) {
    ...
    if((addr&0x1) == 0){ //half word valignment
      proc.cpu.gpr[p.args.D.rt] = proc.mmu.read_half(addr);
    } else {
      uint16_t data = 0;
      data |= proc.mmu.read_byte(addr);
      data <<= 8;
  ...
  PseudoStatus ppc_lhzux(PPC_Processor &proc, const PPC_PseudoInstruction& p) {
    ...
    if((addr&0x1) == 0){ //half word valignment
      proc.cpu.gpr[p.args.X.rt] = proc.mmu.read_half(addr);
    } else {
      uint16_t data = 0;
      data |= proc.mmu.read_byte(addr);
      data <<= 8;
  ...
  PseudoStatus ppc_lwa_ra0(PPC_Processor &proc, const PPC_PseudoInstruction& p) {
    ...
    uint32_t addr = p.args.DS.ds;
    if((addr&0x3) == 0){ //word valignment
      proc.cpu.gpr[p.args.DS.rt] = proc.mmu.read_word(addr);
    } else {
      int i;
      uint32_t data = 0;
      for(i = 0; i < 3; i++, data <<= 8) {
      ...
      data |= proc.mmu.read_byte(addr+i);
      proc.cpu.gpr[p.args.DS.rt] = data;
    }
    return OK;
  }
  ...
  PseudoStatus ppc_lwa_raS(PPC_Processor &proc, const PPC_PseudoInstruction& p) {
    ...
    uint32_t addr = proc.cpu.gpr[p.args.DS.ra] + p.args.DS.ds;
    if((addr&0x3) == 0){ //word valignment
      proc.cpu.gpr[p.args.DS.rt] = proc.mmu.read_word(addr);
    } else {
      int i;
...
/*--------------------------------------------------------------------------*/
  PseudoStatus ppc_lwbrx_ra0(PPC_Processor &proc, const PPC_PseudoInstruction& p) {
    ...
    if((addr&0x3) == 0){ //word valignment
      proc.cpu.gpr[p.args.X.rt] = word_be_le_translate(proc.mmu.read_word(addr));
    } else {
      int i;
      uint32_t data = 0;
      for(i = 0; i < 3; i++, data <<= 8) {
      ...
      data |= proc.mmu.read_byte(addr+i);
      proc.cpu.gpr[p.args.X.rt] = word_be_le_translate(data);
    }
 ...
 PseudoStatus ppc_mullw_(PPC_Processor &proc, const PPC_PseudoInstruction& p) {
  ...
  PseudoStatus ppc_mullwo(PPC_Processor &proc, const PPC_PseudoInstruction& p) {
    ...
    int64_t temp = (int32_t)proc.cpu.gpr[p.args.X.ra] * (int32_t)proc.cpu.gpr[p.args.X.rb];
    proc.cpu.gpr[p.args.X.rt] = (uint32_t)temp;
 ...
 PseudoStatus ppc_mullwo_(PPC_Processor &proc, const PPC_PseudoInstruction& p) {
  ...
  PseudoStatus ppc_mulhw(PPC_Processor &proc, const PPC_PseudoInstruction& p) {
    ...
    const int64_t a = (int32_t)proc.cpu.gpr[p.args.X.ra];
    const int64_t b = (int32_t)proc.cpu.gpr[p.args.X.rb];
    int64_t c = a * b;
    proc.cpu.gpr[p.args.X.rt] = ((uint64_t) c) >> 32;
  ...
  PseudoStatus ppc_mulhwu(PPC_Processor &proc, const PPC_PseudoInstruction& p) {
    ...
    const uint64_t a = proc.cpu.gpr[p.args.X.ra];
    const uint64_t b = proc.cpu.gpr[p.args.X.rb];
    uint64_t c = a * b;
    proc.cpu.gpr[p.args.X.rt] =  c >> 32;
