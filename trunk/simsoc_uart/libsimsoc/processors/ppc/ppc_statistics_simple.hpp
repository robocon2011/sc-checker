...
#ifndef PPC_STATISTICS_SIMPLE_HPP
#define PPC_STATISTICS_SIMPLE_HPP
...
namespace simsoc {
  ...
  struct PPC_StatisticsSimple: PPC_Statistics {

    PPC_StatisticsSimple();
    ...
    // void visit(PPC_FPArithmetic<PPC_fadd> &instruction);
    // void visit(PPC_FPArithmetic<PPC_fadd_> &instruction);
//     void visit(PPC_FPArithmetic<PPC_fadds> &instruction);
//     void visit(PPC_FPArithmetic<PPC_fadds_> &instruction);
//     void visit(PPC_FPArithmetic<PPC_fdiv> &instruction);
//     void visit(PPC_FPArithmetic<PPC_fdiv_> &instruction);
//     void visit(PPC_FPArithmetic<PPC_fdivs> &instruction);
//     void visit(PPC_FPArithmetic<PPC_fdivs_> &instruction);
//     void visit(PPC_FPArithmetic<PPC_fmul> &instruction);
//     void visit(PPC_FPArithmetic<PPC_fmul_> &instruction);
//     void visit(PPC_FPArithmetic<PPC_fmuls> &instruction);
//     void visit(PPC_FPArithmetic<PPC_fmuls_> &instruction);
//     void visit(PPC_FPArithmetic<PPC_fsub> &instruction);
//     void visit(PPC_FPArithmetic<PPC_fsub_> &instruction);
//     void visit(PPC_FPArithmetic<PPC_fsubs> &instruction);
//     void visit(PPC_FPArithmetic<PPC_fsubs_> &instruction);
    //void visit(PPC_FPArithmetic_lop<PPC_fsqrt> &instruction);
    //void visit(PPC_FPArithmetic_lop<PPC_fsqrt_> &instruction);
    //void visit(PPC_FPArithmetic_lop<PPC_fsqrts> &instruction);
    //void visit(PPC_FPArithmetic_lop<PPC_fsqrts_> &instruction);
//     void visit(PPC_FPConvert<PPC_fctid> &instruction);
//     void visit(PPC_FPConvert<PPC_fctid_> &instruction);
//     void visit(PPC_FPConvert<PPC_fctidz> &instruction);
//     void visit(PPC_FPConvert<PPC_fctidz_> &instruction);
//     void visit(PPC_FPConvert<PPC_fctiw> &instruction);
//     void visit(PPC_FPConvert<PPC_fctiw_> &instruction);
//     void visit(PPC_FPConvert<PPC_fctiwz> &instruction);
//     void visit(PPC_FPConvert<PPC_fctiwz_> &instruction);
//     void visit(PPC_FPCompare<PPC_fcmpo> &instruction);
//     void visit(PPC_FPCompare<PPC_fcmpu> &instruction);
//     void visit(PPC_FPMultiAdd<PPC_fmadd> &instruction);
//     void visit(PPC_FPMultiAdd<PPC_fmadd_> &instruction);
//     void visit(PPC_FPMultiAdd<PPC_fmadds> &instruction);
//     void visit(PPC_FPMultiAdd<PPC_fmadds_> &instruction);
//     void visit(PPC_FPMultiAdd<PPC_fmsub> &instruction);
//     void visit(PPC_FPMultiAdd<PPC_fmsub_> &instruction);
//     void visit(PPC_FPMultiAdd<PPC_fmsubs> &instruction);
//     void visit(PPC_FPMultiAdd<PPC_fmsubs_> &instruction);
//     void visit(PPC_FPMultiAdd<PPC_fnmadd> &instruction);
//     void visit(PPC_FPMultiAdd<PPC_fnmadd_> &instruction);
//     void visit(PPC_FPMultiAdd<PPC_fnmadds> &instruction);
//     void visit(PPC_FPMultiAdd<PPC_fnmadds_> &instruction);
//     void visit(PPC_FPMultiAdd<PPC_fnmsub> &instruction);
//     void visit(PPC_FPMultiAdd<PPC_fnmsub_> &instruction);
//     void visit(PPC_FPMultiAdd<PPC_fnmsubs> &instruction);
//     void visit(PPC_FPMultiAdd<PPC_fnmsubs_> &instruction);
//     void visit(PPC_fabs &instruction);
//     void visit(PPC_fabs_ &instruction);
//     void visit(PPC_fcfid &instruction);
//     void visit(PPC_fcfid_ &instruction);
//     void visit(PPC_fmadds &instruction);
//     void visit(PPC_fmr &instruction);
//     void visit(PPC_fmr_ &instruction);
//     void visit(PPC_fnabs &instruction);
//     void visit(PPC_fnabs_ &instruction);
//     void visit(PPC_fneg &instruction);
//     void visit(PPC_fneg_ &instruction);
//     void visit(PPC_fres &instruction);
//     void visit(PPC_fres_ &instruction);
//     void visit(PPC_frsp &instruction);
//     void visit(PPC_frsp_ &instruction);
//     void visit(PPC_frsqrte &instruction);
//     void visit(PPC_frsqrte_ &instruction);
//     void visit(PPC_fsel &instruction);
//     void visit(PPC_fsel_ &instruction);
...
#endif // PPC_STATISTICS_SIMPLE_HPP
